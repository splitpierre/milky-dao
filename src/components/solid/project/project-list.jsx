        ...
        <>
          {projects().value.map(
            ({
              ...
              <a href={`/project/${id}`}>
                <div class="project-entry-list w-full max-w-sm rounded-lg bordershadow-md ">
                  ...
                  <div class="flex flex-col items-center pb-10">
                    <img
                      ...
                      alt={title}
                    />
                    <h5 class="mb-1 text-xl font-medium text-center h-16">
                      {title}
                    </h5>
                    <h5 class="text-sm text-gray-500 dark:text-gray-400 p-3 lg:h-28 md:h-auto">
                      {shortDescription}
                    </h5>
                  </div>
                  <div class="p-4 border-t text-xs text-white-700 columns-2">
                    <div class="justify-center items-center text-center">
                      ...
                      <dt class="mb-1 text-2xl font-bold">
                        {proposals.length}
                      </dt>
                    </div>
                    <div class="justify-center items-center text-center">
